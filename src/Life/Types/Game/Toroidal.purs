...
import Life.Types.Life (class CellularAutomaton, class InteractiveAutomaton, class Life, class TangibleAutomaton, extractCell, focusCell, fromCells, toCells, update)
